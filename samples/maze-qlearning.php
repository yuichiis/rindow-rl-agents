...
$env=new Maze($hostLa,null,WIDTH,HEIGHT,EXIT_STATE,true,MAX_EPISODE_STEPS);
$evalEnv=new Maze($hostLa,$env->mazeRules(),WIDTH,HEIGHT,EXIT_STATE,true,MAX_EPISODE_STEPS);
