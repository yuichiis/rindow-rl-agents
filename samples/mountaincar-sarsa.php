...
const MODEL_FILE = __DIR__.'/../models/mountaincar-sarsa.weights';
const HISTORY_FILE = __DIR__.'/../graphics/mountaincar-sarsa-history.png';
const ANIMATION_FILE = __DIR__.'/../graphics/mountaincar-sarsa-animation.gif';
