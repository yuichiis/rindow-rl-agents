...
class AbstractEstimatorNetworkTest extends TestCase
{
    ...
    public function testTrainingDiscreteActions()
    {
        ...
        $network = new TestNetwork($nn,stateShape:[1],numActions:2,fcLayers:[100]);
    ...
    //    $la = $mo->la();
    //    $nn = $this->newBuilder($mo);
    //    $network = new TestNetwork($nn,$stateShape=[1],$numActions=[4],fcLayers:[100]);
...
//
    ...
    //        [  1,  1,NAN,NAN],
    //    ]);
    //    $network = new TestNetwork($nn,$stateShape=[1],$numActions=[4],fcLayers:[100],rules:$rules);
...
//
    ...
    //    $nn = $this->newBuilder($mo);
//
    //    $network = new TestNetwork($nn,stateShape:[],numActions:2,fcLayers:[100]);
...
//
    ...
    //        [  1,  1,NAN,NAN],
    //    ]);
    //    $network = new TestNetwork($nn,stateShape:[],numActions:4,fcLayers:[100],rules:$rules);
