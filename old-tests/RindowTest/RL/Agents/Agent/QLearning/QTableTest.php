<?php
namespace RindowTest\RL\Agents\Agent\QLearning\QTableTest;
...
class QTableTest extends TestCase
{
...
//
    ...
    public function testInitTable()
    {
        ...
        $network = new QTable($la,$numStates,$numActions);
        //$states = $la->array([[0],[1],[2]]);
        $table = $network->table();
        //$rules0 = $la->nan2num($la->copy($rules));
        //$table0 = $la->nan2num($la->copy($table));
        ...
        //echo $mo->toString($table1,null,true);
        //$this->assertEquals([[1,0,0],[0,1,0],[0,0,1]],$table1->toArray());
        $this->assertEquals($trues->shape(),$table->shape());
...
//
    ...
    public function testGetQValues()
    {
        ...
        //echo $mo->toString($qValues,null,true);
        $table = $network->table();
        $trues = $la->gatherb($table,$la->squeeze($states,axis:-1));

        $this->assertTrue($la->isclose($trues,$qValues));
        ...
        //$qValues3 = $la->nan2num($la->copy($qValues3))->toArray();
        //$qValues4 = $la->nan2num($la->copy($qValues4))->toArray();
        $this->assertTrue($la->isclose($qValues,$qValues3));
        $this->assertFalse($la->isclose($qValues,$qValues4));
