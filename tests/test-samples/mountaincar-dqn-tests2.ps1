$model_file = 'models/mountaincar-dqn'
$history_file = 'graphics/mountaincar-dqn'
$animation_file = 'graphics/mountaincar-dqn'
$device = 'cpu'
...
$env:RL_SEED = "42"
echo "Running MountainCar DQN with ${paramstr}-seed${env:RL_SEED} on device: ${device}"
...
$log_file = "logs/mountaincar-dqn" + "-" + $paramstr + "-seed" + $env:RL_SEED + "-" + $device + ".log"
php samples/mountaincar-dqn.php > $log_file
