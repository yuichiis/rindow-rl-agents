$model_file = 'models/mountaincar-sarsa'
$history_file = 'graphics/mountaincar-sarsa'
$animation_file = 'graphics/mountaincar-sarsa'
$device = 'cpu'
...
$env:RL_SEED = "42"
echo "Running MountainCar Sarsa with ${paramstr}-seed${env:RL_SEED} on device: ${device}"
...
$log_file = "logs/mountaincar-sarsa" + "-" + $paramstr + "-seed" + $env:RL_SEED + "-" + $device + ".log"
php samples/mountaincar-sarsa.php > $log_file
